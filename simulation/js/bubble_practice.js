...
function check_swap(){
  ...
  if(temp == 1)
  {
    ...
    // Remove SCORM tracking from practice
  }else
  ...
  if(n!=bubble_artefact.numOfCards-1)
    ...
    bubble_artefact.finished = true;
    // Remove SCORM tracking from practice - this is just practice
    document.getElementById("ins").innerHTML = "Practice completed! Great job learning!";
  }
};
